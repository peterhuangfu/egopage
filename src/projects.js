module.exports = [
  { 
    ...
    description: [
      ...
      'Utilized two deep learning models with Python to complete the task - Stacked Hourglass Model and Onset-and-Frames Model.',
      'Presented the result via website, which is developed with Vue.js, Node.js and MongoDB.',
